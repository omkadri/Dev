...
FClassRegistrationInfo Z_Registration_Info_UClass_UCommonLoadingScreenSettings;
UClass* UCommonLoadingScreenSettings::GetPrivateStaticClass()
{
	using TClass = UCommonLoadingScreenSettings;
	if (!Z_Registration_Info_UClass_UCommonLoadingScreenSettings.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("CommonLoadingScreenSettings"),
			Z_Registration_Info_UClass_UCommonLoadingScreenSettings.InnerSingleton,
			StaticRegisterNativesUCommonLoadingScreenSettings,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UCommonLoadingScreenSettings.InnerSingleton;
}
UClass* Z_Construct_UClass_UCommonLoadingScreenSettings_NoRegister()
{
	return UCommonLoadingScreenSettings::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Parrot_Plugins_CommonLoadingScreen_Source_CommonLoadingScreen_Private_CommonLoadingScreenSettings_h__Script_CommonLoadingScreen_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UCommonLoadingScreenSettings, UCommonLoadingScreenSettings::StaticClass, TEXT("UCommonLoadingScreenSettings"), &Z_Registration_Info_UClass_UCommonLoadingScreenSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCommonLoadingScreenSettings), 2170370938U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Parrot_Plugins_CommonLoadingScreen_Source_CommonLoadingScreen_Private_CommonLoadingScreenSettings_h__Script_CommonLoadingScreen_3384143664(TEXT("/Script/CommonLoadingScreen"),
	Z_CompiledInDeferFile_FID_Parrot_Plugins_CommonLoadingScreen_Source_CommonLoadingScreen_Private_CommonLoadingScreenSettings_h__Script_CommonLoadingScreen_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Parrot_Plugins_CommonLoadingScreen_Source_CommonLoadingScreen_Private_CommonLoadingScreenSettings_h__Script_CommonLoadingScreen_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
