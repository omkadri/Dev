...
public class AudioManager : MonoBehaviour
{
    ...
    [SerializeField] SoundsCollectionSO _soundsCollectionSO;
    ...
    void OnEnable()
    {
        RangedWeapon.OnShoot += RangedWeapon_OnShoot;
        RangedWeapon.OnGrenadeShoot += RangedWeapon_OnGrenadeShoot;
    ...
    void Health_OnDeath(Health health)//TODO: Investigate differentiating between player health and enemy health???
    {
    ...
    List<Health> _deathList = new List<Health>();
