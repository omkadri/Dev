...
public class Trivia2D : MonoBehaviour
{
    [Header("Questions")]
    [SerializeField] TextMeshProUGUI _questionText;
    [SerializeField] List<Trivia2DQuestionSO> _questions = new List<Trivia2DQuestionSO>();
    ...
    Trivia2DQuestionSO _currentQuestion;
    Color _defaultQuestionColor;
    public bool IsComplete { get; set; }

    Trivia2DTimer _quizTimer;
    Trivia2DScoreKeeper _scoreKeeper;


    void Awake()
    {
        _quizTimer = FindFirstObjectByType<Trivia2DTimer>();
